...
import { DB_USER } from "@/mock/assets_backup";
      ...
      <Form {...form} {...props}>
        <form onSubmit={form.handleSubmit(handleFinish)} className="space-y-4">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input {...field} placeholder={DB_USER.map((user) => user.username).join("/")} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            control={form.control}
            name="password"
            rules={{ required: t("sys.login.passwordPlaceholder"), maxLength: 20 }}
            render={({ field }) => (
              <FormItem>
