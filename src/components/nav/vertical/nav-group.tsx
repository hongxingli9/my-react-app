...
function Group({
  ...
  return (
    name && (
      <div
        className={cn(
          "group w-full inline-flex items-center justify-start relative gap-2 cursor-pointer pt-4 pr-2 pb-2 pl-3 transition-all transition-300 ease-in-out",
          "hover:pl-4",
        )}
      ...
      >
        <Icon
          ...
          className={cn(
            "absolute -left-1 h-4 w-4 inline-flex shrink-0 transition duration-300 ease-in-out",
