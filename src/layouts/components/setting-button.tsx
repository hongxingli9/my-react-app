...
import { themeVar } from "@/theme/theme.css";
...
export default function SettingButton() {
  ...
  const updateSettings = (partialSettings: Partial<SettingsType>) => {
    setSettings({ ...setttings, ...partialSettings });
  };
  ...
  const layoutBackground = (layout: ThemeLayout) =>
    themeLayout === layout
      ? themeVar.colors.palette.primary.light
      : themeVar.colors.palette.gray[500];
    ...
    <Sheet modal={false}>
      ...
      >
              ...
              <div className="flex flex-row gap-4">
                ...
                >
                  <Icon
                    ...
                    size="24"
                    color={
                      themeMode === ThemeMode.Light ? themeVar.colors.palette.primary.default : ""
                    }
                  />
                </Card>
                <Card
                ...
                >
                  <Icon
                    ...
                    size="24"
                    color={
                      themeMode === ThemeMode.Dark ? themeVar.colors.palette.primary.default : ""
                    }
                  />
                </Card>
              </div>
                ...
                >
                  <div className="flex h-full w-5 flex-col gap-1 p-1">
                    <div
                      ...
                      style={{ backgroundColor: layoutBackground(ThemeLayout.Vertical) }}
                    />
                    <div
              ...
              <div className="flex flex-wrap gap-1">
                {Object.entries(presetsColors).map(([preset, color]) => (
                  <div
                    key={preset}
                    className={cn(
                      "relative flex h-13 w-5 cursor-pointer items-center justify-center rounded transition-all duration-300 ease-in-out",
                  ...
                  >
                    <div
                      className={cn(
                        "w-full h-full felx items-center justify-center hover:bg-white/30 transition-all duration-300 ease-in-out rounded",
                ...
                {Object.entries(FontFamilyPreset).map(([font, family]) => (
                  <Card
                    ...
                    className={cn(
                      ...
                      family === FontFamilyPreset.inter && "font-inner",
        ...
        <SheetFooter className="px-6 py-4 border border-t shrink-0">
          <Button
            variant="outline"
            className="w-full boder-dashed text-text-primary hover:border-primary hover:text-primary"
